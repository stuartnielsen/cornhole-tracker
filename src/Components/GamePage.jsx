...
Feature: Single Player (Allow players to choose practice. This will let them choose shots 
         they want to work on and challenge that type of shot or scenerio)  
*/
